...
namespace CameraImage
{
    public partial class Form1 : Form
    {
        ...
        private void btnAddModel_Click(object sender, EventArgs e)
        {
            ...
            if (str == "") { str = "默认"; };
            if (false == System.IO.Directory.Exists("f:model-" + str))
            {
                System.IO.Directory.CreateDirectory("f:model-" + str);
            }
            else
            {
            ...
            for (hv_i = 1; (int)hv_i <= 4; hv_i = (int)hv_i + 1)
            {
                ...
                HOperatorSet.WriteShapeModel(hv_ModelID, ("f:/model-"+str+"/modle" + hv_i) + ".shm");
